jQuery(document).ready(function ($) {
  ...
  $("#countdown").countdown({ until: new Date(2022,3, 24) }); // enter event day
  ...
  owl.owlCarousel({
    ...
    navigation: true,
    navigationText: [
      '<i class="fa fa-4x fa-chevron-circle-left"></i>',
      '<i class="fa fa-4x  fa-chevron-circle-right"></i>',
    ],
  });
...
function init_map() {
  ...
  marker = new google.maps.Marker({
    map: map,
    position: new google.maps.LatLng(18.6517288, 73.7594511), //change the coordinates
  });
